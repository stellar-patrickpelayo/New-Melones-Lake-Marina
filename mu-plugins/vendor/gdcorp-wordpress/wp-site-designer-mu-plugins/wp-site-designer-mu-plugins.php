...
use GoDaddy\WordPress\Plugins\SiteDesigner\Plugins\EditorContentSaver;
use GoDaddy\WordPress\Plugins\SiteDesigner\Plugins\ChangeHighlighter;
...
use GoDaddy\WordPress\Plugins\SiteDesigner\Plugins\SafariStorageAccess;
...
use GoDaddy\WordPress\Plugins\SiteDesigner\Plugins\StatusBarHider;
...
add_action(
	...
	function () {
		...
		// Safari storage access needs to run outside iframe context but requires plugin activation.
		if ( IframeContextDetector::isPluginActivated() ) {
			SafariStorageAccess::init();
		}
