...
function enqueueStyleSheets(){
	...
	wp_enqueue_style('source_sans', 'href="https://fonts.googleapis.com/css2?family=Source+Sans+Pro&display=swap"');
    wp_enqueue_style('font-awesome', 'http://maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css');
    wp_enqueue_style('style-non-sass', get_template_directory_uri() . '/style-non-sass.css');
