        <footer class='main-footer'>
                ...
                <div class='footer-columns-wrapper'>
                    ...
                    <div class='column'>
                        ...
                        <ul>
							...
							<li style='display:grid;' class="list-grid last-list-grid address-contact"><span><strong>Business Office Hours:</strong><br>Monday &amp; Wednesday 9:00AM-3:00PM</span></li>
                        </ul>
                    </div>
                    <div class='column'>
                        <h3>Quick Links</h3>
            ...
            <div class='lower-footer'>
				...
				<!--	<span>•</span>
					...
					target="_blank"
					title="Boat Rental Software by Stellar IMS"
					>Boat Rental Software by Stellar IMS</a> -->
            	</div>
