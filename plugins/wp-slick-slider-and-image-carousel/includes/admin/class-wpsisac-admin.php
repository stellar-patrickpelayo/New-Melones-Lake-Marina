...
class Wpsisac_Admin {
	...
	function wpsisac_register_menu() {
		...
		// add_submenu_page( 'edit.php?post_type='.WPSISAC_POST_TYPE, __('Join $0 Pro Trail - WP Slick Slider and Image Carousel', 'wp-slick-slider-and-image-carousel'), '<span style="color:#ff2700">'.__('Join $0 Pro Trail', 'wp-slick-slider-and-image-carousel').'</span>', 'manage_options', 'wpsisac-premium', array($this, 'wpsisac_premium_page') );
	...
	// 	include_once( WPSISAC_DIR . '/includes/admin/settings/trail-premium.php' );
	// }
